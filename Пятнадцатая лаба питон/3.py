...
"""
Введите кол-во клиентов, которых хотите записать: 3
Введите год (2000-2010): 2006
Введите месяц (1-12): 2
Введите продолжительность занятий в часах (1-30): 30
Введите код клиента (10-99): 55
Введите год (2000-2010): 2006
Введите месяц (1-12): 4
Введите продолжительность занятий в часах (1-30): 30
Введите код клиента (10-99): 55
Введите год (2000-2010): 2006
Введите месяц (1-12): 3
Введите продолжительность занятий в часах (1-30): 30
Введите код клиента (10-99): 55
Введите код нужного клиента: 55
В году 2006 клиент 55 меньше всего занимался в месяц 11 - всего 30 часов.
Почему 11 месяц?
"""
class FitnessEntry:
