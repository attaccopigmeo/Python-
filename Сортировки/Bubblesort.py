...
"""
Пузырьковая сотрировка - это алгоритм сортировки, при котором сраниваются два подряяд идущих числа,//
если a1 > a2, то a2 перемещается на позицию перед числом a1.
"""
def bubblesort(arr):
